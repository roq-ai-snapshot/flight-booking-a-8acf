  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless air travel with Flight Booking Application - your ultimate choice for the best flight deals and hassle-free booking experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmbGlnaHR8ZW58MHx8fHwxNjk5NDM4ODAxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless air travel with Flight Booking Application - your ultimate choice for the best flight deals and hassle-free booking experience.`}
            </Text>
            <Box
