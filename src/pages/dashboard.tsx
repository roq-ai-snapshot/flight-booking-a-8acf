...
import { useRoqPlatformUserProfiles, useCustomerServiceCount, useFlightCount, useBookingCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const customerServiceStat = useCustomerServiceCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: customerServiceStat?.data,
      isLoading: customerServiceStat.isLoading,
