...
import { useCustomerServiceFindFirst, useRoqClient } from 'lib/roq';
...
function CustomerServiceViewPage() {
  ...
  const { data, error, isLoading } = useCustomerServiceFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Service Description" text={data?.service_description} />
