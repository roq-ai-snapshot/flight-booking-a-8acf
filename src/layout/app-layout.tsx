...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['travel-agent', 'administrator', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Flights', path: '/flights', entity: 'flight', service: AccessServiceEnum.PROJECT, icon: FiAirplay },
    { name: 'Tickets', path: '/tickets', entity: 'ticket', service: AccessServiceEnum.PROJECT, icon: FiTag },
